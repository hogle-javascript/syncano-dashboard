...
const PricingPlans = React.createClass({
  ...
  getChildContext() {
    return {
      currentPlanLimits: this.props.currentPlanLimits
    };
  },
        ...
        <div style={styles.container}>
          <div className="row vm-3-b">
            ...
            <div
              ...
              style={styles.heading}
            >
              {_.inRange(currentPlanLimits.api.included, 999999, 2000001) && <span>Your Current Plan is</span>}
            </div>
            <div
              className="col-flex-1"
              style={styles.heading}
            >
              {_.inRange(currentPlanLimits.api.included, 4999999, 100000001) && <span>Your Current Plan is</span>}
            </div>
          </div>
          <div className="row">
            <PricingPlansPlan
...
PricingPlans.childContextTypes = {
